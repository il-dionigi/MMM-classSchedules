...
module.exports = NodeHelper.create({
	...
	runPython: function() {
		const self = this;
		const fileName = 'classSchedules.py';
		console.log('Running ' + fileName);
		const wordPyShell = new PythonShell(fileName, {mode: 'json', scriptPath: 'modules/MMM-classSchedules', args: []});
